...
pyttsx3.speak("welcome to my menu driven and voice assistant program")
print("\n\t\tWELCOME" )
print("\t      ----------- ")
...
while True:
    ...
    if ("do not"in p)or("don't"in p):
    ...
    elif("hello"in p)or("hi"in p)or("hy"in p):
        pyttsx3.speak("Hello.....")
        print("\nHello.....\n")
        ...
        pyttsx3.speak("I am Jack and your personal assistant....")
        print("\nI am Jack and your personal assistant....\n")
    ...
    elif("what you can do for me"in p):
    ...
    elif("command prompt" in p)or ("command line"in p):
        os.system("start cmd")
